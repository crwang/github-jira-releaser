...
class Versioning {
  ...
  versionMoreRecentThan(currentVersion, otherVersion) {
    if (!this.isValidVersion(currentVersion) || !this.isValidVersion(otherVersion)) {
      return false // TODO: should actually throw an exception
    }
    return this.getMomentFromVersion(currentVersion) > this.getMomentFromVersion(otherVersion)
  }
